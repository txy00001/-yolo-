...
# 加载自定义模型
model = YOLO("qx_daluosi_829_5点/s_pose/weights/best.pt")
...
for video_file in os.listdir(input_folder):
    if video_file.endswith(".mp4"):
        ...
        # 定义要保存的视频文件路径和格式
        output_file = os.path.join(output_folder, "output_" + video_file)
        ...
        while cap.isOpened():
            ...
            # 预测当前帧
            results = model(frame, imgsz=(384,640),conf=0.25)
