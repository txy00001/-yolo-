...
source_folders = [
    ...
    '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/0904向右倾斜数据',
]
# 新的目标文件夹
target_pic_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/pic_1'
target_json_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/json_1'
