...
# 路径配置
pic_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/pic_all'
txt_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/txt_all'
train_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/train'
val_folder = '/mnt/P40_NFS/20_Research/30_算法项目/打螺丝_5点/val'
...
# 计算训练集和验证集的数量
train_size = int(total_images * 0.95)###全部用于训练
